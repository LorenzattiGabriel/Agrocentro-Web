...
import { getOrderLabel, getOrderOptions } from "./utils/utils";
import type { Props } from "./Props";


export default function OrdernarButton({section, selectedOrder, setSelectedOrder}: Props){
    ...
    return(
        <div className="relative" ref={dropdownRef}>
            ...
            >
                Ordenar por: <span className="font-semibold">{getOrderLabel(selectedOrder, section)}</span>
            ...
            {dropdownOpen && (
                <ul
                    ...
                    onBlur={(e)=>{handleDropdownBlur(e, dropdownRef, setDropdownOpen)}}
                >
                    {getOrderOptions(section).map(opt => (
                        <li
                            key={opt.value}
                            role="option"
